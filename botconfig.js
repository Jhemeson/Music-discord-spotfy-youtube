module.exports = {
  ...
  CookieSecret: "shirimbabo", //A Secret like a password
  IconURL:
    "https://raw.githubusercontent.com/SudhanPlayz/Discord-MusicBot/master/assets/logo.gif", //URL of all embed author icons | Dont edit unless you dont need that Music CD Spining
  EmbedColor: "RANDOM", //Color of most embeds | Dont edit unless you want a specific color instead of a random one each time
  Permissions: 2205281600, //Bot Inviting Permissions
  Website: process.env.Website || "https://musica-discordia3.herokuapp.com", //Website where it is hosted at includes http or https || Use "0.0.0.0" if you using Heroku || Do not include /api/callback. Just the website url. I.e. "https://foo.bar"
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "c8c4850382fa4cd59f0abf02fadbf31c", //Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "6a78f557773243e8bc00c3f0afdee99a", //Spotify Client Secret
  },
};
